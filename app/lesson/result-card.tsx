...
type ResultCardProps = {
  value: number;
  variant: "point" | "hearts";
};

export const ResultCard = ({ value, variant }: ResultCardProps) => {
  const imageSrc = variant === "point" ? "/point.svg" : "/heart.svg";

  return (
    <div
      className={cn(
        "w-full rounded-2xl border-2",
        variant === "point" && "border-orange-400 bg-orange-400",
